// VENDORED FROM paperclip-minion/packages/shared/src/types/company-portability.ts @ 1bcd90b38694bd8158356afd4c8bbb3994da6503
...
export interface CompanyPortabilityExportPreviewResult {
  ...
  counts: { files: number; agents: number; skills: number; projects: number; issues: number };
  warnings: string[];
  paperclipExtensionPath: string;
}
