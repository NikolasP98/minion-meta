// VENDORED FROM paperclip-minion/packages/shared/src/types/routine.ts @ 1bcd90b38694bd8158356afd4c8bbb3994da6503

export type RoutineVariableType = 'text' | 'textarea' | 'number' | 'boolean' | 'select';
