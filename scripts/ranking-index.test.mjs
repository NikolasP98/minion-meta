...
test('pending and apply form a strict, idempotent ranking pipeline', () => {
	...
	writeFileSync(index, JSON.stringify({ schemaVersion: 1, rubricVersion: 'board-goal-v1', generatedAt: '2026-08-31T00:00:00.000Z', rankings: [] }));
	...
	writeFileSync(scores, JSON.stringify({ scores: [{ key: candidate.key, criticality: 8, importance: 7, impact: 6, confidence: 9, rationale: 'Blocks an important release.', evidence: ['status:draft'] }] }));
