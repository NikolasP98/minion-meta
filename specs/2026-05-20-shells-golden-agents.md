...
updated: 2026-08-18
repos: [minion-meta]
link_review: "status \"superseded\" but no other spec's \"supersedes\" links back to it — confirm the successor (it should add supersedes: 2026-05-20-shells-golden-agents), or correct this status if it was set in error"
---
