...
**Goal**: Exactly one WS/gateway client implementation exists across the platform, living in `@minion/shared`, consumed by hub, site, and paperclip's `minion_gateway` adapter.
**Depends on**: Phase 4
