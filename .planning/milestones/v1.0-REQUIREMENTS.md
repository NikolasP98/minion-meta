# Requirements Archive: v1.0 Minion Meta-Repo Foundation
...
- [x] **WS-01**: WS client duplication audited across hub, site, and paperclip's `minion_gateway` adapter; report written to specs
...
- [x] **WS-04**: `paperclip-minion` `minion_gateway` adapter updated to consume the shared client
