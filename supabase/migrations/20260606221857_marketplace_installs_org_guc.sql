-- Server-side org isolation for marketplace_installs via the app_ledger role + app.current_org_id
...
--> statement-breakpoint
grant select, insert, update, delete on public.marketplace_installs to app_ledger;
--> statement-breakpoint
...
--> statement-breakpoint
drop policy if exists marketplace_installs_org_guc on public.marketplace_installs;
--> statement-breakpoint
create policy marketplace_installs_org_guc on public.marketplace_installs for all
