-- Server-side org isolation for settings via the app_ledger role + app.current_org_id
...
--> statement-breakpoint
grant select, insert, update, delete on public.settings to app_ledger;
--> statement-breakpoint
alter table public.settings enable row level security;
--> statement-breakpoint
alter table public.settings force row level security;
--> statement-breakpoint
drop policy if exists settings_org_guc on public.settings;
--> statement-breakpoint
create policy settings_org_guc on public.settings for all
