-- Server-side org isolation for session_tasks via the app_ledger role + app.current_org_id
...
--> statement-breakpoint
grant select, insert, update, delete on public.session_tasks to app_ledger;
--> statement-breakpoint
alter table public.session_tasks enable row level security;
--> statement-breakpoint
alter table public.session_tasks force row level security;
--> statement-breakpoint
drop policy if exists session_tasks_org_guc on public.session_tasks;
--> statement-breakpoint
create policy session_tasks_org_guc on public.session_tasks for all
