-- Server-side org isolation for sessions via the app_ledger role + app.current_org_id
...
--> statement-breakpoint
grant select, insert, update, delete on public.sessions to app_ledger;
--> statement-breakpoint
alter table public.sessions enable row level security;
--> statement-breakpoint
alter table public.sessions force row level security;
--> statement-breakpoint
drop policy if exists sessions_org_guc on public.sessions;
--> statement-breakpoint
create policy sessions_org_guc on public.sessions for all
