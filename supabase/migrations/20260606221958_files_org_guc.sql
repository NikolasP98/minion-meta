-- Server-side org isolation for files via the app_ledger role + app.current_org_id
...
--> statement-breakpoint
grant select, insert, update, delete on public.files to app_ledger;
--> statement-breakpoint
alter table public.files enable row level security;
--> statement-breakpoint
alter table public.files force row level security;
--> statement-breakpoint
drop policy if exists files_org_guc on public.files;
--> statement-breakpoint
create policy files_org_guc on public.files for all
