-- Server-side org isolation for tasks via the app_ledger role + app.current_org_id
...
--> statement-breakpoint
grant select, insert, update, delete on public.tasks to app_ledger;
--> statement-breakpoint
alter table public.tasks enable row level security;
--> statement-breakpoint
alter table public.tasks force row level security;
--> statement-breakpoint
drop policy if exists tasks_org_guc on public.tasks;
--> statement-breakpoint
create policy tasks_org_guc on public.tasks for all
