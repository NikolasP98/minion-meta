-- Server-side org isolation for chat_messages via the app_ledger role + app.current_org_id
...
--> statement-breakpoint
grant select, insert, update, delete on public.chat_messages to app_ledger;
--> statement-breakpoint
alter table public.chat_messages enable row level security;
--> statement-breakpoint
alter table public.chat_messages force row level security;
--> statement-breakpoint
drop policy if exists chat_messages_org_guc on public.chat_messages;
--> statement-breakpoint
create policy chat_messages_org_guc on public.chat_messages for all
