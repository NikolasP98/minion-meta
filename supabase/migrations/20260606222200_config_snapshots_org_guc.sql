-- Server-side org isolation for config_snapshots via the app_ledger role + app.current_org_id
...
--> statement-breakpoint
grant select, insert, update, delete on public.config_snapshots to app_ledger;
--> statement-breakpoint
alter table public.config_snapshots enable row level security;
--> statement-breakpoint
alter table public.config_snapshots force row level security;
--> statement-breakpoint
drop policy if exists config_snapshots_org_guc on public.config_snapshots;
--> statement-breakpoint
create policy config_snapshots_org_guc on public.config_snapshots for all
