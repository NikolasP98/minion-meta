-- Server-side org isolation for skill_execution_stats via the app_ledger role + app.current_org_id
...
--> statement-breakpoint
grant select, insert, update, delete on public.skill_execution_stats to app_ledger;
--> statement-breakpoint
alter table public.skill_execution_stats enable row level security;
--> statement-breakpoint
alter table public.skill_execution_stats force row level security;
--> statement-breakpoint
drop policy if exists skill_execution_stats_org_guc on public.skill_execution_stats;
--> statement-breakpoint
create policy skill_execution_stats_org_guc on public.skill_execution_stats for all
