-- Server-side org isolation for server_backups via the app_ledger role + app.current_org_id
...
--> statement-breakpoint
grant select, insert, update, delete on public.server_backups to app_ledger;
--> statement-breakpoint
alter table public.server_backups enable row level security;
--> statement-breakpoint
alter table public.server_backups force row level security;
--> statement-breakpoint
drop policy if exists server_backups_org_guc on public.server_backups;
--> statement-breakpoint
create policy server_backups_org_guc on public.server_backups for all
