...
`handoff-minion-hub-2131866440` (crm-journey) — all three markers point back to
`2026-08-17-hub-reserva-keyword-config` (in-spec), which names `crm-finance.service.ts:9`
