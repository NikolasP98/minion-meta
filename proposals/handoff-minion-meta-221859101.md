...
- `NikolasP98/minion-meta@dev rankings/index.json:7933` — this hasn't been exercised against a live local Supabase",
  https://github.com/NikolasP98/minion-meta/blob/dev/rankings/index.json#L7933
- `NikolasP98/minion-meta@dev rankings/index.json:8066` — remove once the phone failure is root-caused'",
  https://github.com/NikolasP98/minion-meta/blob/dev/rankings/index.json#L8066
- `NikolasP98/minion-meta@dev rankings/index.json:9315` — drawer still shows no LINKED POS TICKETS — spec §4.1",
  https://github.com/NikolasP98/minion-meta/blob/dev/rankings/index.json#L9315
- `NikolasP98/minion-meta@dev rankings/index.json:9347` — The service now binds this version and verifies normalized",
