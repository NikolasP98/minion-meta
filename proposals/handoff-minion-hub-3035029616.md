...
- `NikolasP98/minion_hub@master src/routes/(app)/pos/appointments/+page.svelte:155` — "retries on the next settle" means a week that failed
  https://github.com/NikolasP98/minion_hub/blob/master/src/routes/(app)/pos/appointments/+page.svelte#L155
