...
- `NikolasP98/minion_hub@master tests/dependencies/locale-parity.test.ts:3` — this file is a partial regression guard, not the migration.
  https://github.com/NikolasP98/minion_hub/blob/master/tests/dependencies/locale-parity.test.ts#L3
