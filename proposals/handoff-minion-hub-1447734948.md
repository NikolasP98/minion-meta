...
- `NikolasP98/minion_hub@master src/lib/components/pos/SellableWizard.svelte:344` — other consumption-mapping surfaces (e.g.
  https://github.com/NikolasP98/minion_hub/blob/master/src/lib/components/pos/SellableWizard.svelte#L344
